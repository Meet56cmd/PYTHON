...
mixed_data_types = ['Meet Vasava', 21, 165, 'Unmarried', 'Bharuch']
...
ages = [19, 27, 18, 24, 20, 23, 20, 24, 29, 22]
...
# List of countries
countries = ['Japan', 'Russia', 'USA', 'Netherlands', 'France', 'Austria', 'Switzerland']
